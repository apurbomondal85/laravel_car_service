...
class TicketAssignObserver
{
    ...
    public function created(TicketAssign $ticketAssign)
    {
        ...
        Helper::createActivityLog('Created', 'Ticket Assign', $difference, request()->ip(), request()->userAgent());
    }
    ...
    public function updated(TicketAssign $ticketAssign)
    {
        ...
        Helper::createActivityLog('Updated', 'Ticket Assign', $difference, request()->ip(), request()->userAgent());
    }
    ...
    public function deleted(TicketAssign $ticketAssign)
    {
        ...
        Helper::createActivityLog('Deleted', 'Ticket Assign', $difference, request()->ip(), request()->userAgent());
    }
    ...
    public function restored(TicketAssign $ticketAssign)
    {
        ...
        Helper::createActivityLog('Restored', 'Ticket Assign', $difference, request()->ip(), request()->userAgent());
    }
    ...
    public function forceDeleted(TicketAssign $ticketAssign)
    {
        ...
        Helper::createActivityLog('Force Deleted', 'Ticket Assign', $difference, request()->ip(), request()->userAgent());
    }
}
