...
class TicketReplyObserver
{
    ...
    public function created(TicketReply $ticketReply)
    {
        ...
        Helper::createActivityLog('Created', 'Ticket Reply', $difference, request()->ip(), request()->userAgent());
    }
    ...
    public function updated(TicketReply $ticketReply)
    {
        ...
        Helper::createActivityLog('Updated', 'Ticket Reply', $difference, request()->ip(), request()->userAgent());
    }
    ...
    public function deleted(TicketReply $ticketReply)
    {
        ...
        Helper::createActivityLog('Deleted', 'Ticket Reply', $difference, request()->ip(), request()->userAgent());
    }
    ...
    public function forceDeleted(TicketReply $ticketReply)
    {
        ...
        Helper::createActivityLog('Force Deleted', 'Ticket Reply', $difference, request()->ip(), request()->userAgent());
    }
}
