...
$("#pronoun").on("change", function () {
    ...
    if (pronoun == "") {
        ...
        $("#pronoun + .select2-container .select2-selection--single").addClass(
            "box_error"
        );
        error = true;
    } else {
    ...
    if (!isNaN(pronoun)) {
        ...
        $(
            "#pronoun + .select2-container .select2-selection--single"
        ).removeClass("box_error");
    }
});
// location validation
$("#location").on("change", function () {
    ...
    if (location == "") {
        ...
        $("#location + .select2-container .select2-selection--single").addClass(
            "box_error"
        );
        error = true;
    } else {
...
$("#ethnicity").on("change", function () {
    ...
    if (ethnicity == "") {
        ...
        $(
            "#ethnicity + .select2-container .select2-selection--single"
        ).addClass("box_error");
        error = true;
    } else {
...
$("#iwi").on("change", function () {
    ...
    if (iwi == "") {
        ...
        $("#iwi + .select2-container .select2-selection--single").addClass(
            "box_error"
        );
        error = true;
    } else {
    ...
    if (!isNaN(iwi)) {
        ...
        $("#iwi + .select2-container .select2-selection--single").removeClass(
            "box_error"
        );
    }
});
