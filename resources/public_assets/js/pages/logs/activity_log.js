        ...
        if (typeof(beforeData) == 'number') {
            ...
            beforeDataKey.forEach(function(beforeDataKey, index) {
                if (beforeDataKey == 'created_at' || beforeDataKey == 'updated_at') {
                    $('#logTableBody').append('<tr><td>'+ beforeDataKey +'</td><td>'+  moment(beforeDataValue[index]).format('DD-MM-YYYY, hh:m:ss A') +'</td></tr>');
                } else {
            ...
            beforeDataKey.forEach(function(beforeDataKey, index) {
                if (beforeDataKey == 'updated_at') {
                    $('#logTableBody').append('<tr><td>'+ afterDataKey[index] +'</td><td>'+ moment(beforeDataValue[index]).format('DD-MM-YYYY, hh:m:ss A') +'</td><td>'+  moment(afterDataValue[index]).format('DD-MM-YYYY, hh:m:ss A') +'</td></tr>');
                } else {
