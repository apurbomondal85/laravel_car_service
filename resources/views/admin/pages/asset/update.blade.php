...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Update Asset')) }}</h4>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="p-sm-3">
                            ...
                            <div class="form-group row @error('name') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name"
                                        value="{{ old('name', $asset->name) }}" placeholder="{{ __('Name') }}"
                                        required>
                                    @error('name')
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="asset_type" required>
                                        ...
                                        @foreach($asset_type as $value)
                                            <option value="{{ $value }}" {{(old("asset_type", $asset->asset_type) == $value) ? "selected" : ""}}>
                            ...
                            <div class="form-group row @error('purchased_date') error @enderror">
                                <label class="col-sm-3 col-form-label required" for="purchased_date">{{ __('Purchase Date') }}</label>
                                <div class="col-sm-9">
                                    <input type="date" name="purchased_date" class="form-control" max="{{ now()->format('Y-m-d') }}"
                                        value="{{old('purchased_date', $asset->purchased_date)}}" required>
                            ...
                            <div class="form-group row @error('warranty_date') error @enderror">
                                <label class="col-sm-3 col-form-label" for="warranty_date">{{ __('Warranty Date') }}</label>
                                <div class="col-sm-9">
                                    <input type="date" name="warranty_date" id="warranty_date" class="form-control"
                                        value="{{old('warranty_date', $asset->warranty_date)}}" min="{{ now()->format('Y-m-d') }}">
                                    @error('warranty_date')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row @error('vender_info') error @enderror">
                                <label class="col-sm-3 col-form-label required" for="vender_info">{{ __('Vendor Info') }}</label>
                                <div class="col-sm-9">
                                    <textarea type="text" name="vender_info" class="form-control" required
                                        placeholder="{{ __('Write About Vendor') }}" rows="4">{{ old('vender_info', $asset->vender_info) }}</textarea>
                                    @error('vender_info')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group row @error('quantity') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="quantity" id="quantity"
                                            value="{{ old('quantity', $asset->quantity) }}" placeholder="{{ __('Quantity') }}"
                                            required>
                                        @error('quantity')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="form-group row @error('price') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" step="0.01" name="price" id="price"
                                            value="{{ old('price', $asset->price) }}" placeholder="{{ __('Unit Price') }}"
                                            required>
                                        @error('price')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="form-group row @error('total') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="total" step="0.01" id="total"
                                            value="{{ old('total', $asset->total) }}" placeholder="{{ __('Total') }}" readonly>
                                        @error('total')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row @error('description') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" name="description" class="form-control" required
                                            placeholder="{{ __('Write About Asset') }}" rows="4">{{ old('description', $asset->description) }}</textarea>
                                        @error('description')
                                            <p class="error-message">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row @error('attachments') error @enderror">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="file-upload-section">
                                            <input name="attachments" type="file" class="form-control d-none"
                                            ...
                                            <div class="display-input-image"
                                                style="display: {{ $asset->attachments ? '' : 'd-none' }}">
                                                <img src="{{ $asset->getAssetImage() }}" alt="Preview Image" />
                                                <button type="button"
