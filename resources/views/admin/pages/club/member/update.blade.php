...
@section('title', __('Update Club Member'))
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Update Club Member')) }}</h4>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="p-sm-3">
                    <form action="{{ route('admin.club.member.update', [$club->id, $member->id]) }}" method="post"
                        ...
                        <div class="card-body py-sm-4">
                            ...
                            <div class="form-group row @error('user_type') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <select class="select form-control" name="user_type" id="user_type"
                                        ...
                                        <option value="{{ $key }}"
                                            {{ old('user_type', $member->user_type) == $key ? 'selected' : '' }}>
                            ...
                            <div class="form-group row @error('designation') error @enderror @if(!$member->designation ) d-none @endif" id="designation_div">
                                <label class="col-sm-3 col-form-label required"
                            ...
                            <div class="col-sm-9">
                                <textarea name="note" placeholder="Not about Club" id="message"
                                    class="form-control" rows="8"> {{ old('note', $member->note) }}</textarea>
                                @error('note')
                                <p class="error-message">{{ $message }}</p>
                                @enderror
                            </div>
