...
@section('title', __('New Committee Member'))
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('New Committee Member')) }}</h4>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="p-sm-3">
                    <form action="{{ route('admin.committee.member.create', $committee->id) }}" method="post"
                        ...
                        <div class="card-body py-sm-4">
                            ...
                            <div class="form-group row @error('role') error @enderror">
                            ...
                            <div class="form-group row @error('vote') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="vote" value="{{ old('vote') }}"
                            ...
                            <div class="form-group row @error('image') error @enderror">
                                <label class="col-sm-3 col-form-label required"> Picture </label>
                                <div class="col-sm-9">
                                    <div class="file-upload-section">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" disabled=""
                                                readonly placeholder="Size: 600x600 and max 500kB">
