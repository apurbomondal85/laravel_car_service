...
@section('title', __('New Project Image'))
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('New Project Image')) }}</h4>
        </div>
        {!! \App\Library\Html::linkBack(route('admin.project.index')) !!}
    </div>

    <form method="post" id="create-form" action="{{ route('admin.project.storeProjectImage', $project->id) }}" enctype="multipart/form-data">
        @csrf
