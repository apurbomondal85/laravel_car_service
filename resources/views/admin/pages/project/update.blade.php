...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Update Project')) }}</h4>
        </div>
        {!! \App\Library\Html::linkBack(route('admin.project.index')) !!}
    </div>

    <form method="post" id="create-form" action="{{ route('admin.project.update', $project->id) }}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row pt-4">
                        ...
                        <div class="form-group row @error('name') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name"
                                    value="{{ old('name', $project->name) }}" placeholder="{{ __('Write Project Title') }}"
                                    required>
                                @error('name')
                        ...
                        <div class="form-group row @error('url') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="url" id="url"
                                    value="{{ old('url', $project->url) }}" placeholder="{{ __('Ex: https://example.com') }}">
                                @error('url')
                                    <p class="error-message">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="form-group row @error('featured_image') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <div class="file-upload-section">
                                    ...
                                    <div class="display-input-image @if($project->featured_image == null) d-none @endif">
                                        <img src="{{ $project->getImage() }}" alt="Preview Image" />
                                        <button type="button"
                    ...
                    <div class="col-md-6">
                        <div class="form-group row @error('short_description') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" name="short_description" class="form-control"
                                    placeholder="{{ __('Write Short Description') }}" rows="4">{{ old('short_description', $project->short_description) }}</textarea>
                        ...
                        <div class="form-group row @error('description') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="summernote" name="description" autofocus="autofocus">{{ old('description', $project->description) }}</textarea>
                                @error('description')
                                    <p class="error-message">{{ $message }}</p>
                                @enderror
