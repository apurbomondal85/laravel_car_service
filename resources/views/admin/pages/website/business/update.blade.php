...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Update Business')) }}</h4>
        </div>
                            ...
                            <div class="form-group row @error('url') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="url"
                                        value="{{ old('url', $business->url) }}" placeholder="{{ __('Write Company URL') }}">
                                    @error('url')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="ranking">
                                        ...
                                        @foreach($ranking as $key => $value)
                                            <option value="{{ $key }}" {{(old("ranking", $business->ranking) == $key) ? "selected" : ""}}>
                                                {{ ucwords($value) }}</option>
                                        @endforeach
                                    </select>
                                    @error('ranking')
