    ...
    <div class="content-wrapper">
        ...
        <div class="card mb-4 shadow-sm col-md-6">
            <div class="card-body py-sm-4">
                ...
                <div class="pt-4">
                    <form action="{{ route('admin.club.member.create', $club->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group row @error('user_type') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="user_type" required>
                                        ...
                                        <option value="member" {{(old("user_type") == 'member') ? "selected" : ""}}>Member</option>
                                        <option value="committee" {{(old("user_type") == 'committee') ? "selected" : ""}}>Committee</option>
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="designation" required>
                                        ...
                                        @foreach($designation as $value)
                                            <option value="{{ $value }}" {{(old("designation") == $value) ? "selected" : ""}}>
                            ...
                            <div class="form-group row @error('note') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" name="note" class="form-control"
                                        placeholder="{{ __('Write Short Notes') }}" rows="4">{{ old('note') }}</textarea>
                                    @error('note')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
