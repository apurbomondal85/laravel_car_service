...
<div class="content-wrapper">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <input type="hidden" id="eventStatus" value="{{ $active_status }}">

            <table class="table table-bordered no-footer dtr-inline" id="eventDataTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Title</th>
...
@push('scripts')
    ...
    @vite('resources/admin_assets/js/website/event/index.js')
