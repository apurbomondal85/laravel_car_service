...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-between">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('Faqs' )) }}</h4>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <input type="hidden" id="faqStatus" value="{{ $active_status }}">


            <table class="table table-bordered no-footer dtr-inline" id="faqDataTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Question</th>
...
@push('scripts')
    ...
    @vite('resources/admin_assets/js/website/faq/index.js')
