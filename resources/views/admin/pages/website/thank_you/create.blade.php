...
@section('title', __('New Thank You'))
...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        <div class="d-block">
            <h4 class="content-title">{{ strtoupper(__('New Thank You')) }}</h4>
        </div>
    ...
    <div class="card shadow-sm col-md-12">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.thanks.create') }}" enctype="multipart/form-data">
                @csrf
                <div class="p-sm-3">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row @error('title') error @enderror">
                                <label class="col-sm-3 col-form-label required">{{ __('Thank You Title') }}</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="title"
                                        value="{{ old('title') }}" placeholder="{{ __('Write Your Thank You Title') }}"
                                        required>
                                    @error('title')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
