        ...
        <tbody>
            <tr>
                <td style="padding: 40px 0;">
                    ...
                    <table
                        style="width:100%;max-width:620px;margin:0 auto;background-color: #ffffff;border: 2px solid gainsboro;">
                        <tbody class="email-body">
                            <tr style="border-bottom: 1px solid #dcdcdc85;">
                                <td style="    text-align: center;padding: 10px 0;">
                                    <a href="{{ url('/') }}">
                                        <img style="width: 120px;" src="{{ asset('frontend/logo/BanglaConstraction.png') }}" alt="Logo">
                                    </a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding: 5px 30px">
                                    <strong>Phone:</strong> {{$mailData['phone']}}
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 5px 30px">
                            ...
                            <tr style="border-top: 1px solid #dcdcdc85;">
                                <td style="text-align: center;padding: 7px 0;">
                                    <p style="font-size: 13px;">{{ settings('copyright')?? 'Copyright©Bangla Constructor'}}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
