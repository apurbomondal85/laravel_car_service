...
<main id="main">
    ...
    <section id="services-page" class="services-page">
        <div class="container">
            <div class="row gx-xl-5 gx-4 gy-xl-5 gy-4 px-xxl-5">
                    ...
                    <div class="services-card position-relative">
                        <div class="services-text position-relative">
                            <div class="position-absolute">
                                ...
                                <button class="btn read-btn mt-1" data-bs-toggle="modal"
                                    data-bs-target="#servicesModal">Read More</button>
                            </div>
                        </div>
    ...
    @include('public.components.modals.service-details-modal')
</main>
@endsection